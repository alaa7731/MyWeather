...
public class Sequent {
    ...
    public static class Builder {
        ...
        public Sequent.Builder offset(int offset) {
            this.startOffset = offset;
            return this;
        }

        public Sequent.Builder duration(int duration) {
            this.duration = duration;
            return this;
        }

        public Sequent.Builder delay(int delay) {
            this.delay = delay;
            return this;
        }

        public Sequent.Builder flow(Direction direction) {
            this.direction = direction;
            return this;
        }

        public Sequent.Builder anim(Context context, int animId) {
            this.context = context;
            this.animId = animId;
            return this;
        }

        public Sequent.Builder anim(Context context, Animation anim) {
            this.context = context;
            this.anim = anim;
            return this;
        }
    ...
    public static Sequent.Builder origin(ViewGroup vg) {
        return new Sequent.Builder(vg);
    }
